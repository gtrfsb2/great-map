...
export function DebugPanel() {
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    e.preventDefault();
    const pos = panelPos ?? { x: Math.max(12, window.innerWidth - 492), y: Math.max(12, window.innerHeight - 412) };
    setIsDragging(true);
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <span style={{ cursor: isDragging ? 'grabbing' : 'grab', marginRight: '4px', color: '#475569', fontSize: '12px' }} title="Перетащи панель">⠿</span>
